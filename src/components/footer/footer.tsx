    ...
    <>
      <section className="footer-partners" aria-label="Partners">
        ...
        <ul className="partner-logos">
          ...
          <li className="partner-logo">
            <img src={northside} alt="Partner Logo" className="partner-logo" />
          </li>
          <li className="partner-logo">
            <img src={smartkids} alt="Partner Logo" className="partner-logo" />
          </li>
          <li className="partner-logo">
            <img
              src={transcarbon}
      ...
      <footer className="site-footer" role="contentinfo">
        <div className="footer-inner container">
          ...
          <section className="footer-newsletter" aria-label="Newsletter signup">
            ...
            <p className="brand-desc">
              Join our newsletter for course updates, partner offers, and
              curated resources.
            </p>
